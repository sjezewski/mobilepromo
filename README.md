...
This is a sample project, so you will find the code commented to help you follow what is happening. There are [tutorials to follow on the Moovweb site](https://console.moovweb.com/learn/tutorials/building_a_site/start) which explain how this project was made.
